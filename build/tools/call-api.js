...
export function registerCallApiTool(server) {
    server.tool("execute_api_call", "Ejecuta una llamada a la API especificada con los parámetros dados.", {
        ...
        try {
            ...
            return createErrorResponse(`Error de red: ${error.message}`, toolName);
        }
        finally {
            cleanup();
        }
