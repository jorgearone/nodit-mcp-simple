...
export function registerGetApiSpecTool(server) {
    server.tool("get_api_specification", "Obtiene la especificación completa de una operación específica.", {
        ...
        try {
            ...
            return createErrorResponse(`Error al obtener especificación: ${error.message}`, toolName);
        }
    });
}
